...
use crate::clarity::functions::{NativeFunctions, DefineFunctionsParsed, NativeVariables};
...
impl <'a, 'b> AnalysisPass for TypeChecker <'a> {
...
impl <'a> TypeChecker <'a> {
    fn new(db: &'a mut AnalysisDatabase) -> TypeChecker<'a> {
        Self {
            db,
