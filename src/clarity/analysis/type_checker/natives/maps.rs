...
use crate::clarity::types::{TypeSignature, Value, PrincipalData, get_definition_type_of_tuple_argument};

use crate::clarity::types::TupleDefinitionType::{Implicit, Explicit};

use super::check_special_tuple_cons;
use crate::clarity::analysis::type_checker::{TypeResult, TypingContext, 
...
fn check_and_type_map_arg_tuple(checker: &mut TypeChecker, expr: &SymbolicExpression, context: &TypingContext) -> TypeResult {
    match get_definition_type_of_tuple_argument(expr) {
